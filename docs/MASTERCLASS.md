# AI Automators Masterclass — Original README

*This is the original course README from the AI Automators Claude Code RAG Masterclass. The repo-root [README.md](../README.md) is the portfolio pitch for the live deployment.*
