...
- [x] 04-02-PLAN.md -- Tree sidebar, folder data hook, file list view, breadcrumb, DocumentsPage rewrite
- [x] 04-03-PLAN.md -- Context menus, inline rename, confirm dialog, folder picker, folder creation UI
- [x] 04-04-PLAN.md -- Drag-and-drop (@dnd-kit/react), bulk selection, bulk action bar, drop-to-upload
