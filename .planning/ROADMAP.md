...
- [x] 16-03-PLAN.md — Frontend failed-state card: ToolEvent 'error' status + red ToolCallCard branch (depends on 16-02 SSE flag)
- [x] 16-04-PLAN.md — Live prod verify (SC-5): deploy + Fly secret + success/failure smokes (checkpoint, autonomous:false)
...
**Plans**: 11 plans (6 waves) + 2 gap-closure plans (Wave 7, parallel — from 17-VERIFICATION.md)
...
- [x] 17-06-PLAN.md — GET /api/personas router + per-turn persona resolver in chat.py
- [x] 17-07-PLAN.md — PATCH persona (exclude_unset) + preferences default_persona
- [x] 17-08-PLAN.md — [BLOCKING] apply migration 035 to dev + remove SYSTEM_PROMPT env-shadow
- [x] 17-09-PLAN.md — PersonaSelector + DefaultPersonaSelector components
...
- [ ] 17-12-PLAN.md — [gap-closure] Chat picker displays the effective active persona, display-only (SC-1/3/4; PERS-01/03/04/05)
...
| 17. Agent Personas | v1.3 | 11/13 | Gap-closure | 2026-07-14 |
